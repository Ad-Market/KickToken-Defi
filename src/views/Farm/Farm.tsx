...
import { getMasterChefContract } from '../../kkt/utils'
...
const Farm: React.FC = () => {
  ...
  const { onRedeem } = useRedeem(getMasterChefContract(kkt))
    ...
    <>
      ...
      <StyledFarm>
        ...
        <StyledInfo>
          ...
          automagically harvest KKT rewards for you!
        </StyledInfo>
        <Spacer size="md" />
        <StyledLink
          target="__blank"
          href={`https://kktswap.vision/pair/${lpTokenAddress}`}
        >
          {lpTokenName} Info
        </StyledLink>
      </StyledFarm>
