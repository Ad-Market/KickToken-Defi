...
const StakeKkt: React.FC<StakeProps> = ({}) => {
  const tokenName = "KKT"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.kkt[56])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`KKT Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
